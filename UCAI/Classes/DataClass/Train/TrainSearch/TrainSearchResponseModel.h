...
@property (nonatomic, copy) NSString *TrainType;	//列车等级
@property (nonatomic, copy) NSString *StartCity;	//出发车站
@property (nonatomic, copy) NSString *StartTime;	//出发时间，时间格式为“HH:mm”
@property (nonatomic, copy) NSString *EndCity;	//到达车站
@property (nonatomic, copy) NSString *EndTime;	//到达时间，时间格式为“HH:mm”
...
@interface TrainSearchResponseModel : NSObject
