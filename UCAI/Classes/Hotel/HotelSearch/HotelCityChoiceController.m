...
@implementation HotelCityChoiceController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	self.hotelSearchController.cityLabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
	self.hotelSearchController.cityCode = [[citySection objectAtIndex:indexPath.row] objectAtIndex:1];
