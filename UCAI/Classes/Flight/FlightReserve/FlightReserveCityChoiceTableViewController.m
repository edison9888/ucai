//
//  FlightReserveCityChoiceTableViewController.m
//  UCAI
//
...
@implementation FlightReserveCityChoiceTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (_cityType) {
        case 1:
            self.flightReserveViewController.startedCityShowlabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            self.flightReserveViewController.startCityCode = [[citySection objectAtIndex:indexPath.row] objectAtIndex:1];
            break;
        case 2:
            self.flightReserveViewController.arrivedCityShowlabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            self.flightReserveViewController.arrivedCityCode = [[citySection objectAtIndex:indexPath.row] objectAtIndex:1];
            break;
    }
