//
//  FlightBookingCityChoiceTableViewController.m
//  UCAI
//
...
@implementation FlightBookingCityChoiceTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (_cityType) {
        case 1:
            self.flightSearchViewController.startedCityShowlabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            self.flightSearchViewController.startCityCode = [[citySection objectAtIndex:indexPath.row] objectAtIndex:1];
            break;
        case 2:
            self.flightSearchViewController.arrivedCityShowlabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
            self.flightSearchViewController.arrivedCityCode = [[citySection objectAtIndex:indexPath.row] objectAtIndex:1];
            break;
    }
