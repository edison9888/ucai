//
//  WeatherCityChoiceTableViewController.m
//  UCAI
//
...
@implementation WeatherCityChoiceTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    self.weatherSearchViewController.cityNameLabel.text = [[citySection objectAtIndex:indexPath.row] objectAtIndex:0];
    self.weatherSearchViewController.cityLat = [NSString stringWithFormat:@"%.f",[[[citySection objectAtIndex:indexPath.row] objectAtIndex:2] floatValue]*1000000];
    self.weatherSearchViewController.cityLng = [NSString stringWithFormat:@"%.f",[[[citySection objectAtIndex:indexPath.row] objectAtIndex:3] floatValue]*1000000];
    self.weatherSearchViewController.provinceName = [[citySection objectAtIndex:indexPath.row] objectAtIndex:4];
