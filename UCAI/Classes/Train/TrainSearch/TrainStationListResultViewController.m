...
@synthesize trainDetailResponseModel = _trainDetailResponseModel;
...
- (void)dealloc {
    ...
    [self.trainDetailResponseModel release];
    [super dealloc];
}
...
- (void) loadView{
    ...
    startedDateLabel.text = self.trainDetailResponseModel.sDate;
    ...
    stationLabel.text = [NSString stringWithFormat:@"%@ ⇀ %@",self.startedStationName,self.arrivedStationName];
    ...
    countLabel.text = [NSString stringWithFormat:@"%@个站点",self.trainDetailResponseModel.iCount];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        UILabel * ywsLabel = [[UILabel alloc] initWithFrame:CGRectMake(280, 5, 45, 20)];
        ...
        UILabel * ywzLabel = [[UILabel alloc] initWithFrame:CGRectMake(327, 5, 45, 20)];
        ...
        UILabel * ywxLabel = [[UILabel alloc] initWithFrame:CGRectMake(374, 5, 45, 20)];
        ...
        UILabel * gwsLabel = [[UILabel alloc] initWithFrame:CGRectMake(500, 5, 100, 20)];
        ...
        UILabel * gwxLabel = [[UILabel alloc] initWithFrame:CGRectMake(500, 30, 100, 20)];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
	if ([self.trainDetailResponseModel.data count]<=6) {
